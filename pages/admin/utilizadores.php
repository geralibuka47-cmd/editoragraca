...
/**
 * Editora Graça — Admin Users Management (PHP Version)
 */
$pageTitle = "Gerir Utilizadores | Administração";
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-gray-50 border-b border-gray-100">
                        <tr>
                            <th class="px-8 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">Nome / Email</th>
                            <th class="px-8 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">Cargo / Role</th>
                    ...
                    <tbody id="admin-users-list" class="divide-y divide-gray-50">
                        <tr>
                            <td colspan="4" class="px-8 py-20 text-center text-gray-400 font-bold uppercase tracking-widest text-[10px]">A carregar utilizadores...</td>
                        </tr>
                    </tbody>
                </table>
            </div>
