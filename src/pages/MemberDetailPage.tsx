                        ...
                        <div className="lg:col-span-4 space-y-20">
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    <a href="#" aria-label="Enviar email para o membro" className="flex items-center gap-5 p-6 rounded-3xl bg-gray-50 hover:bg-brand-primary hover:text-white transition-all duration-500 group">
                                    ...
                                    <a href="#" aria-label="Ver perfil do LinkedIn" className="flex items-center gap-5 p-6 rounded-3xl bg-gray-50 hover:bg-brand-primary hover:text-white transition-all duration-500 group">
                                        <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-brand-dark group-hover:scale-110 transition-transform">
