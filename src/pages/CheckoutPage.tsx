    ...
    if (step === 'cart') {
        return (
            <div className="min-h-screen bg-brand-light py-8 md:py-16">
                <SEO title="Carrinho de Compras" description="Finalize sua compra na Editora Graça. Verifique seus livros e prepare-se para ler." />
                ...
                <div className="container mx-auto px-4 md:px-8">
                    <button
                        ...
                        aria-label="Voltar para a página inicial e continuar comprando"
                    >
                    ...
                    {/* Stepper */}
                    <div className="flex items-center justify-between max-w-2xl mx-auto mb-12 relative" aria-label="Passos da compra">
                        <div className="absolute top-1/2 left-0 w-full h-0.5 bg-gray-200 -translate-y-1/2 z-0"></div>
                        <div className={`stepper-line ${stepperWidth}`}></div>

                        <div className="relative z-10 flex flex-col items-center gap-2">
                            <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-black text-xs sm:text-sm transition-all duration-500 ${step1Style}`} aria-current="step">
                                1
                            </div>
                            <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-brand-dark text-center">Carrinho</span>
                        </div>

                        <div className="relative z-10 flex flex-col items-center gap-2">
                            <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-black text-xs sm:text-sm transition-all duration-500 ${step2Style}`}>
                                2
                            </div>
                            <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-brand-dark text-center">Detalhes</span>
                        </div>

                        <div className="relative z-10 flex flex-col items-center gap-2">
                            <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-black text-xs sm:text-sm transition-all duration-500 ${step3Style}`}>
                                3
                            </div>
                            <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-brand-dark text-center">Sucesso</span>
                        </div>
                    </div>
                    ...
                    {cart.length === 0 ? (
                        <div className="bg-white rounded-3xl shadow-lg p-16 text-center">
                            ...
                            <button onClick={() => navigate('/livros')} className="btn-premium" aria-label="Ir para o catálogo de livros">
                                Explorar Catálogo
                            </button>
                        </div>
                    ) : (
                        <div className="grid lg:grid-cols-3 gap-8">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                                <div className="flex items-center gap-2 bg-gray-100 rounded-lg p-1 w-fit">
                                                    ...
                                                    <span className="w-8 text-center font-bold text-sm" aria-label={`Quantidade: ${item.quantity}`}>{item.quantity}</span>
                                                    <button
                            ...
                            <div className="lg:col-span-1">
                                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 sticky top-20 sm:top-24">
                                    ...
                                    <Button onClick={handleCheckout} className="w-full py-4 uppercase tracking-widest text-xs" aria-label="Ir para detalhes de faturação">
                                        Finalizar Compra
                                    </Button>
                            ...
                            <div className="mobile-cart-sticky">
                                ...
                                <Button onClick={handleCheckout} className="px-8 py-3 text-[10px]" aria-label="Finalizar compra">
                                    Finalizar
                                </Button>
                            </div>
                        </div>
