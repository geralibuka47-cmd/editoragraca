                ...
                <div className="flex-1 overflow-y-auto p-8 md:p-12 pt-16 custom-scrollbar">
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5">
                        <button
                            ...
                            className="w-full py-4 rounded-xl bg-white/10 hover:bg-white/15 text-white/80 text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-3 transition-all border border-white/5"
                        >
