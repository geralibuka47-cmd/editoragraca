    ...
    return (
        <div className="min-h-screen bg-[#0fb48b] flex items-center justify-center p-6 selection:bg-[#0fb48b] selection:text-white font-sans">
            ...
            >
                ...
                {/* ── Tabs ─────────────────────────────────────────────── */}
                <div className="flex gap-12 justify-center mb-10 mt-8">
                    <Link
                        to="/login"
                ...
                <AnimatePresence mode="wait">
                    ...
                    {method === 'phone' && (
                        <m.div key="phone" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} className="space-y-6">
                            <AnimatePresence mode="wait">
                                {phoneStep === 1 && (
                                    <m.form key="p1" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} onSubmit={handlePhone(onPhoneSend)} className="space-y-6">
                ...
                <div className="mt-8 pt-8 border-t border-white/5 text-center">
                    ...
                    <p className="mt-4 text-[9px] text-gray-600 uppercase tracking-widest leading-relaxed">
