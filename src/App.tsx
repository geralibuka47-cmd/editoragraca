...
import { Sparkles, BookOpen, ArrowRight, Zap, Star, Trophy, Mail, Loader2, Clock } from 'lucide-react';
                ...
                <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-white">
                    ...
                    <div className="container mx-auto px-4 md:px-8 grid lg:grid-cols-2 items-center gap-10 md:gap-20 py-10 md:py-20 relative z-10">
                        <div className="space-y-6 md:space-y-10 animate-fade-in text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 md:gap-6 pt-4">
                                <button
                                    ...
                                    onClick={() => upcomingLaunch ? handleViewDetails(upcomingLaunch) : handleNavigate('CATALOG')}
                                >
                        ...
                        <div className="relative animate-fade-in delay-200">
                            <div className="relative z-10 w-full aspect-[4/5] bg-brand-light rounded-3xl shadow-2xl overflow-hidden border-8 border-white group cursor-pointer" onClick={() => featuredBook && handleViewDetails(featuredBook)}>
